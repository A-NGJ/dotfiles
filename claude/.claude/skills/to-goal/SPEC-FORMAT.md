# Contract format — the living spec

A behavioral contract that outlives the work order. It describes what a user
...
— happy paths, edge cases, error states, and every actor the feature touches.
...
internal file paths belong in the work order's Scope instead.
